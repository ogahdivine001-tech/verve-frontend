...
export default function Contact() {
  ...
  const onSubmit = async (data) => {
    // No dedicated contact endpoint yet; this simulates submission and can be
    // wired to POST /api/contact once that route is added on the backend.
  ...
  return (
    <div className="container-page py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-sm text-ink-soft/60">Questions about an order or a product? We're here to help.</p>
      </div>
      ...
      <div className="grid md:grid-cols-[1fr_1.4fr] gap-12 max-w-4xl mx-auto">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-ink-soft/60">12 Commerce Street, Abuja, Nigeria</p>
            </div>
          </div>
          <div className="flex gap-3">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div>
            <label className="text-xs uppercase tracking-wide text-ink-soft/60 block mb-1.5">Subject</label>
            <input
