...
export const orderService = {
  ...
  updateStatus: (id, orderStatus, userEmail) =>
    api
      .put(`/orders/${id}/status`, { orderStatus, userEmail })
      .then((r) => r.data),
...
export const reviewService = {
  ...
  getAll: (params) =>
    api.get("/reviews/admin/all", { params }).then((r) => r.data),
  moderate: (id, status) =>
    api.put(`/reviews/${id}/moderate`, { status }).then((r) => r.data),
...
export const uploadService = {
  ...
  deleteImage: (publicId) =>
    api.delete("/uploads", { data: { publicId } }).then((r) => r.data),
};

export const analyticsService = {
  getOverview: (range) =>
    api
      .get("/admin/analytics/overview", { params: { range } })
      .then((r) => r.data),
  getRevenueChart: (range) =>
    api
      .get("/admin/analytics/revenue-chart", { params: { range } })
      .then((r) => r.data),
  getTopProducts: (range) =>
    api
      .get("/admin/analytics/top-products", { params: { range } })
      .then((r) => r.data),
  getCategoryBreakdown: () =>
    api.get("/admin/analytics/category-breakdown").then((r) => r.data),
  getCustomerGrowth: (range) =>
    api
      .get("/admin/analytics/customer-growth", { params: { range } })
      .then((r) => r.data),
};
